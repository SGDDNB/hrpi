...
knitr::kable(core.exprSet.cluster.counts %>% dplyr::select(Cluster_Label, members) %>% arrange(Cluster_Label))
```
...
### Expression plots of genes associated to ATAC-seq peak clusters.
```{r expression_accessibilty_plots}
