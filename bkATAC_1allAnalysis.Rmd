...
# Annotated clusters
## Basic cluster annotation (based on hg19)

```{r basic_hg19_annotation}
...
## Chromatin accessibility of candidates
Based on fully annotated clusters (Homer, see methods), peaks closest to genes TSSs were filtered and selected candidates plot.
Gene expression based on bulk RNA-seq grouped by stage and media were also plot alongside. 
